...
#ifndef ONERT_MICRO_TEST_MODELS_UNIDIRECTIONAL_SEQUENCE_LSTM_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_UNIDIRECTIONAL_SEQUENCE_LSTM_KERNEL_BASE_H
...
template <typename T> class TestDataUnidirectionalSequenceLSTMBase : public TestDataBase<T>
{
public:
...
#endif // ONERT_MICRO_TEST_MODELS_UNIDIRECTIONAL_SEQUENCE_LSTM_KERNEL_BASE_H
