...
luci::CompressionType from_circle_compressiontype(circle::CompressionType type)
{
  switch (type)
  {
    ...
    case circle::CompressionType_RLE:
      return luci::CompressionType::RLE;
    case circle::CompressionType_HUFFMAN_RLE:
      return luci::CompressionType::HUFFMAN_RLE;
    case circle::CompressionType_RLE_HUFFMAN:
      return luci::CompressionType::RLE_HUFFMAN;
    default:
